                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo $data["value1"];?>" name="value1" placeholder="e.g $5000">
                                </div>
