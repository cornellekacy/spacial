...
if(isset($_POST['save'])){
 ...
 $value1 = mysqli_real_escape_string($link,$_POST['value1']);
...
// Attempt insert query execution
    $sql = "INSERT INTO track (jname,jadd,jcountry,jemail,jnumber,sname,sadd,scountry,semail,snumber, prod, mode, ship_date, ddate,ship_time, dtime, currentl, pickupl, status,deliverys,cat,weight,items,packagenum,descrip,ship_id,lon,lat,value1) 
    VALUES ('$jname','$jadd','$jcountry','$jemail','$jnumber','$sname','$sadd','$scountry','$semail','$snumber', '$prod', '$mode', '$ship_date', '$ddate','$ship_time', '$dtime', '$currentl', '$pickupl', '$status','$deliverys','$cat','$weight','$items','$me1','$descrip','$track','$lon','$lat', '$value1')";
                            ...
                            <div class="basic-form">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="value1" placeholder="e.g $5000">
                                </div>
                                <div class="form-group">
